...
#
btnMudarpContatos = CriarBotão(Abas.tab("Reservas"), "Avançar ->", MudarpContato, 12, 12, 30, 30)
...
#Botao
btnVoltarpReservas = CriarBotão(Abas.tab("Contato"), "<- Voltar", VoltarpReservas, 12, 2, 30, 30)
#
